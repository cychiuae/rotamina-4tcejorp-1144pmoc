...
inline Vec4<T> operator *(const Vec4<T>& v, const Mat4<T>& a){
	...
	printf("v*a = %f, %f, %f, %f \n",
		v.n[0] * a.n[0] + v.n[1] * a.n[4] + v.n[2] * a.n[8] + v.n[3] * a.n[12],
		v.n[0] * a.n[1] + v.n[1] * a.n[5] + v.n[2] * a.n[9] + v.n[3] * a.n[13],
		v.n[0] * a.n[2] + v.n[1] * a.n[6] + v.n[2] * a.n[10] + v.n[3] * a.n[14],
		v.n[0] * a.n[3] + v.n[1] * a.n[7] + v.n[2] * a.n[11] + v.n[3] * a.n[15]);
	*/
	return Vec4<T>(
		v.n[0] * a.n[0] + v.n[1] * a.n[4] + v.n[2] * a.n[8] + v.n[3] * a.n[12],
		v.n[0] * a.n[1] + v.n[1] * a.n[5] + v.n[2] * a.n[9] + v.n[3] * a.n[13],
